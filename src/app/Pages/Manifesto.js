...
const Manifesto = () => {
    return <section id="manifesto-page" className="h-screen items-center max-[500px]:items-end flex justify-end">
        <div id="manifesto-content" className="relative w-full p-[2em] z-2">
